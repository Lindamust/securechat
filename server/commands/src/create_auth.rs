use domain::dto::{AuthChallengeInput, AuthChallengeResponse};
use pipeline::{Command, error::PipelineResult, primitives::{IkPub, Nonce}, request::Request, stages::{CommandReady, Executed, Validated}};
...
pub fn build_auth_command(
    ...
    Request::new(CreateAuthCommand { ik_pub: input.ik_pub })
}
